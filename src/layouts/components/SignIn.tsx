            ...
            <div className="flex flex-col gap-3">
              <div className="relative">
                <input
                  ...
                  className="border border-gray-300 rounded-md p-3 pr-10 w-full" // Añade espacio a la derecha para el icono
              ...
              <div className="flex flex-row items-center justify-between">
                ...
                <Link href="/forgot-your-password">
                  <span className="text-xs">Has olvidado tu contraseña?</span>
                </Link>
              </div>
            </div>
            <button
