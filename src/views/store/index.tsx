...
import { FaThLarge, FaListUl } from 'react-icons/fa'; // Para el toggle de vista
    ...
    <div className="w-full h-auto min-h-screen flex flex-col px-4 md:px-10 lg:px-20 py-6 mb-40">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <aside className="w-full lg:w-64 h-auto border p-4 flex-shrink-0">
          <div className="mb-4">
            <h2 className="text-lg mb-2 text-drcuotasTertiary-text font-black uppercase leading-tight tracking-tight">Filtros</h2>
          ...
          {/* Categorías (ejemplo) */}
          <div className="mb-6">
            <h3 className="text-sm mb-2 text-drcuotasTertiary-text font-bold uppercase leading-tight tracking-tight">Categorías</h3>
          ...
          <div className="mb-6">
            <h3 className="text-sm font-bold mb-2 text-drcuotasTertiary-text  uppercase leading-tight tracking-tight">Precio</h3>
          ...
          {/* Estado (ejemplo) */}
          <div className="mb-6">
            <h3 className="text-sm font-bold mb-2 uppercase leading-tight tracking-tight text-drcuotasTertiary-text">Estado</h3>
            <ul className="space-y-1 text-sm text-gray-700">
              <li>
                <label>
                  <input type="checkbox" className="mr-2" />
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <option value="destacado" className='leading-tight tracking-tight'>
                    <span className='leading-tight tracking-tight text-drcuotasTertiary-text'>
                      Destacados
                    </span>
                  </option>
