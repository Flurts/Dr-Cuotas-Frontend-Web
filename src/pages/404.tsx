    ...
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center ">
        <div className="w-full h-full flex flex-col justify-center items-center  text-drcuotasPrimary-text">
          <h1 className="text-6xl font-bold uppercase leading-tight tracking-tight hidden lg:block">404</h1>
          <h1 className="text-lg lg:text-4xl font-bold uppercase leading-tight tracking-tight">
